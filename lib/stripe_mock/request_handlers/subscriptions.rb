  ...
  module RequestHandlers
    module Subscriptions
      ...
      def create_subscription(route, method_url, params, headers)
        ...
        allowed_params = %w(billing days_until_due customer application_fee_percent coupon items metadata plan quantity source tax_percent trial_end trial_period_days current_period_start)
